...
import UIKit
import VueSwift
class NewsHomeNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NewsHomeNavCellModel{
            let m = aModel as! NewsHomeNavCellModel
...
class NewsHomeNavCellModel:VueData{
