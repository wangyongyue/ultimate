...
import UIKit
import VueSwift
class NewMineNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NewMineNavCellModel{
            let m = aModel as! NewMineNavCellModel
...
class NewMineNavCellModel:VueData{
