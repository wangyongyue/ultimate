...
import VueSwift
class NewsHot:Vue,V_ViewControllerProtocol{
    ...
    private func dealContent(){
        ...
        views.append(NewsHotRecom())
        views.append(NewsHotList())
        views.append(NewsHotTopic())
        views.append(NewsHotStar())
