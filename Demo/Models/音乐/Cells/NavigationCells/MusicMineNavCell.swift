...
import VueSwift
class MusicMineNavCell: UITableViewCell {
    ...
    let headerLabel:UILabel = {
     ...
     lazy private var rightButton:UIButton = {
         let a = UIButton()
         a.setImage(UIImage.init(named: "m_3"), for: .normal)
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is MusicMineNavCellModel{
            let m = aModel as! MusicMineNavCellModel
...
class MusicMineNavCellModel:VueData{
