...
import VueSwift
class MusicRecommendNavCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is MusicRecommendNavCellModel{
            let m = aModel as! MusicRecommendNavCellModel
...
class MusicRecommendNavCellModel:VueData{
