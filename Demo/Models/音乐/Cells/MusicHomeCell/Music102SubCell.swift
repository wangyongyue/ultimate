...
import UIKit
import VueSwift
class Music102SubCell: UICollectionViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is Music102SubCellModel{
            
            let m = aModel as! Music102SubCellModel
...
class Music102SubCellModel:VueData{
