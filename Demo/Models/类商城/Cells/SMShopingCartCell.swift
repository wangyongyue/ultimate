...
import UIKit
import VueSwift
class SMShopingCartCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMShopingCartCellModel{
            let m = aModel as! SMShopingCartCellModel
...
class SMShopingCartCellModel:VueData{
