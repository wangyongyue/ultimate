...
import UIKit
import VueSwift
class SMDetailsNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMDetailsNavCellModel{
            let m = aModel as! SMDetailsNavCellModel
...
class SMDetailsNavCellModel:VueData{
