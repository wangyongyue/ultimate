...
import UIKit
import VueSwift
class SMClassificationNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMClassificationNavCellModel{
            let m = aModel as! SMClassificationNavCellModel
...
class SMClassificationNavCellModel:VueData{
