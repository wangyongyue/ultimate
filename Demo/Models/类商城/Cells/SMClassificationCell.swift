...
import UIKit
import VueSwift
class SMClassificationCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMClassificationCellModel{
            let m = aModel as! SMClassificationCellModel
...
class SMClassificationCellModel:VueData{
