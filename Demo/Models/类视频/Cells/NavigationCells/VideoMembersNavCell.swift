...
import UIKit
import VueSwift
class VideoMembersNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoMembersNavCellModel{
            let m = aModel as! VideoMembersNavCellModel
...
class VideoMembersNavCellModel:VueData{
