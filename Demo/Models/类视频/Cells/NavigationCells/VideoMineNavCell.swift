...
import UIKit
import VueSwift
class VideoMineNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoMineNavCellModel{
            let m = aModel as! VideoMineNavCellModel
...
class VideoMineNavCellModel:VueData{
