...
import UIKit
import VueSwift
class SMDiscoveryCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMDiscoveryCellModel{
            let m = aModel as! SMDiscoveryCellModel
...
class SMDiscoveryCellModel:VueData{
