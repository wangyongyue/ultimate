...
import UIKit
import VueSwift
class SMDiscoveryNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMDiscoveryNavCellModel{
            let m = aModel as! SMDiscoveryNavCellModel
...
class SMDiscoveryNavCellModel:VueData{
