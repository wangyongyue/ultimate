...
import UIKit
import VueSwift
class SMShopingCartNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is SMShopingCartNavCellModel{
            let m = aModel as! SMShopingCartNavCellModel
...
class SMShopingCartNavCellModel:VueData{
