...
import UIKit
import VueSwift
class NotesAssistantCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NotesAssistantCellModel{
            
            let m = aModel as! NotesAssistantCellModel
...
class NotesAssistantCellModel:VueData{
