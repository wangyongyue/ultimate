...
import UIKit
import VueSwift
class ShareMineNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ShareMineNavCellModel{
            let m = aModel as! ShareMineNavCellModel
...
class ShareMineNavCellModel:VueData{
