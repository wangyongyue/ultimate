...
import UIKit
import VueSwift
class ShareGoodNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ShareGoodNavCellModel{
            let m = aModel as! ShareGoodNavCellModel
...
class ShareGoodNavCellModel:VueData{
