...
import UIKit
import VueSwift
class TraJourneyCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraJourneyCellModel{
            let m = aModel as! TraJourneyCellModel
...
class TraJourneyCellModel:VueData{
