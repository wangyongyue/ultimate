...
import UIKit
import VueSwift
class TraServiceNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraServiceNavCellModel{
            let m = aModel as! TraServiceNavCellModel
...
class TraServiceNavCellModel:VueData{
