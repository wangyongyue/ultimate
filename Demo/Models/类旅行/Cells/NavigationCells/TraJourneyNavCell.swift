...
import UIKit
import VueSwift
class TraJourneyNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraJourneyNavCellModel{
            let m = aModel as! TraJourneyNavCellModel
...
class TraJourneyNavCellModel:VueData{
