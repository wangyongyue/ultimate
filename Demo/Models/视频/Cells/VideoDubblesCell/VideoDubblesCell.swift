...
import UIKit
import VueSwift
class VideoDubblesCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoDubblesCellModel{
            
            let m = aModel as! VideoDubblesCellModel
...
class VideoDubblesCellModel:VueData{
