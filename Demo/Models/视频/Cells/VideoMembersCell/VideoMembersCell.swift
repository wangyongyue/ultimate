...
import UIKit
import VueSwift
class VideoMembersCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoMembersCellModel{
            
            let m = aModel as! VideoMembersCellModel
...
class VideoMembersCellModel:VueData{
