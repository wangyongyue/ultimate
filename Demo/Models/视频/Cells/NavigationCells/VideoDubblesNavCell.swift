...
import UIKit
import VueSwift
class VideoDubblesNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoDubblesNavCellModel{
            let m = aModel as! VideoDubblesNavCellModel
...
class VideoDubblesNavCellModel:VueData{
