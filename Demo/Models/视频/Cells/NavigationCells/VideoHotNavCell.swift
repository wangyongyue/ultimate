...
import UIKit
import VueSwift
class VideoHotNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoHotNavCellModel{
            let m = aModel as! VideoHotNavCellModel
...
class VideoHotNavCellModel:VueData{
