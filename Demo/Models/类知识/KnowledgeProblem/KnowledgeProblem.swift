...
import UIKit
import VueSwift
class KnowledgeProblem:Vue,V_ViewControllerProtocol{
    ...
    private func dealNav(){
        ...
        var array = [VueData]()
        let m = KnowledgeProblemNavCellModel()
        m.name = "回答问题"
        array.append(m)
    ...
    private func dealContent(){
        ...
        views.append(KnowledgeProblemRecom())
        views.append(KnowledgePopularity())
        views.append(KnowledgeInvitation())
