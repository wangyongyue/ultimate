...
import UIKit
import VueSwift
class NewsHotNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NewsHotNavCellModel{
            let m = aModel as! NewsHotNavCellModel
...
class NewsHotNavCellModel:VueData{
