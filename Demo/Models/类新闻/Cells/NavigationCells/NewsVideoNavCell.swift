...
import UIKit
import VueSwift
class NewsVideoNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NewsVideoNavCellModel{
            let m = aModel as! NewsVideoNavCellModel
...
class NewsVideoNavCellModel:VueData{
