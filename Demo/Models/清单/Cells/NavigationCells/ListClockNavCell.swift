...
import UIKit
import VueSwift
class ListClockNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ListClockNavCellModel{
            let m = aModel as! ListClockNavCellModel
...
class ListClockNavCellModel:VueData{
