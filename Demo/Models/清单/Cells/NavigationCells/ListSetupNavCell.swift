...
import UIKit
import VueSwift
class ListSetupNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ListSetupNavCellModel{
            let m = aModel as! ListSetupNavCellModel
...
class ListSetupNavCellModel:VueData{
