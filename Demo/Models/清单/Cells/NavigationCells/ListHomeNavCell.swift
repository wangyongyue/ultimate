...
import UIKit
import VueSwift
class ListHomeNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ListHomeNavCellModel{
            let m = aModel as! ListHomeNavCellModel
...
class ListHomeNavCellModel:VueData{
