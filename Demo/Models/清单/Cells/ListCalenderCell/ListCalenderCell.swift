...
import UIKit
import VueSwift
class ListCalenderCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ListCalenderCellModel{
            let m = aModel as! ListCalenderCellModel
...
class ListCalenderCellModel:VueData{
