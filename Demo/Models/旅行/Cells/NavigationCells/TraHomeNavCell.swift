...
import UIKit
import VueSwift
class TraHomeNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraHomeNavCellModel{
            let m = aModel as! TraHomeNavCellModel
...
class TraHomeNavCellModel:VueData{
