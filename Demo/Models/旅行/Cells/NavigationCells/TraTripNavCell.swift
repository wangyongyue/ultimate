...
import UIKit
import VueSwift
class TraTripNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraTripNavCellModel{
            let m = aModel as! TraTripNavCellModel
...
class TraTripNavCellModel:VueData{
