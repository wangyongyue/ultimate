...
import UIKit
import VueSwift
class TraServiceCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is TraServiceCellModel{
            let m = aModel as! TraServiceCellModel
...
class TraServiceCellModel:VueData{
