...
import UIKit
import VueSwift
class ListCalenderNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ListCalenderNavCellModel{
            let m = aModel as! ListCalenderNavCellModel
...
class ListCalenderNavCellModel:VueData{
