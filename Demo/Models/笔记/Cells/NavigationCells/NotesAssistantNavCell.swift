...
import UIKit
import VueSwift
class NotesAssistantNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is VideoHomeNavCellModel{
            let m = aModel as! VideoHomeNavCellModel
...
class NotesAssistantNavCellModel:VueData{
