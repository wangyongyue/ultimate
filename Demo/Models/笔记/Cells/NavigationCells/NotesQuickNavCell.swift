...
import UIKit
import VueSwift
class NotesQuickNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NotesQuickNavCellModel{
            let m = aModel as! NotesQuickNavCellModel
...
class NotesQuickNavCellModel:VueData{
