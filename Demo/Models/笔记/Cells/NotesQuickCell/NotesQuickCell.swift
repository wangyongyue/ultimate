...
import UIKit
import VueSwift
class NotesQuickCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is NotesQuickCellModel{
            
            let m = aModel as! NotesQuickCellModel
...
class NotesQuickCellModel:VueData{
