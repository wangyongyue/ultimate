...
import UIKit
import VueSwift
class ShareFoundCell: UITableViewCell {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ShareFoundCellModel{
            
            let m = aModel as! ShareFoundCellModel
...
class ShareFoundCellModel:VueData{
