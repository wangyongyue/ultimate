...
import UIKit
import VueSwift
class ShareHomeNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ShareHomeNavCellModel{
            let m = aModel as! ShareHomeNavCellModel
...
class ShareHomeNavCellModel:VueData{
