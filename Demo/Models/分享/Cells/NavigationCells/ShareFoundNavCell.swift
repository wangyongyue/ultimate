...
import UIKit
import VueSwift
class ShareFoundNavCell: UITableViewCell {
   ...
   override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
    ...
    override func setV_Model(_ aModel: VueData) {
        if aModel is ShareFoundNavCellModel{
            let m = aModel as! ShareFoundNavCellModel
...
class ShareFoundNavCellModel:VueData{
